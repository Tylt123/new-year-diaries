        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .blog-item.-layout6.-contained .image-holder' => 'border-radius: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .blog-item.-layout6.-contained .card-details' => 'border-radius: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .blog-item.-layout1.-contained .image-holder' => 'border-top-right-radius: {{SIZE}}{{UNIT}}; border-top-left-radius: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .blog-item.-layout1.-contained .card-details' => 'border-bottom-right-radius: {{SIZE}}{{UNIT}}; border-bottom-left-radius: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .blog-item.-layout3.-contained .image-holder' => 'border-bottom-left-radius: {{SIZE}}{{UNIT}}; border-top-left-radius: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .blog-item.-layout5.-contained .image-holder' => 'border-bottom-left-radius: {{SIZE}}{{UNIT}}; border-top-left-radius: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .blog-item.-layout3.-contained .card-details' => 'border-bottom-right-radius: {{SIZE}}{{UNIT}}; border-top-right-radius: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .blog-item.-layout5.-contained .card-details' => 'border-bottom-right-radius: {{SIZE}}{{UNIT}}; border-top-right-radius: {{SIZE}}{{UNIT}};'
                ],
            ]
        );
