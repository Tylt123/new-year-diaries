        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .portfolio-item.-layout13.-contained .card-image .image-holder' => 'border-radius: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .portfolio-item.-layout13.-contained .card-details' => 'border-radius: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .portfolio-item.-contained .image-holder' => 'border-top-right-radius: {{SIZE}}{{UNIT}}; border-top-left-radius: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .portfolio-item.-contained .card-details' => 'border-bottom-right-radius: {{SIZE}}{{UNIT}}; border-bottom-left-radius: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
