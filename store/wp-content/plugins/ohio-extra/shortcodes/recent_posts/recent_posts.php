...
function ohio_recent_posts_func( $atts ) {
	...
	*/
	...
	if ( isset( $border_radius ) && $border_radius != '' ) {
		$_style_block .= '#' . $wrapper_id . ' .blog-item.-layout1.-contained .image-holder{';
		$_style_block .= 'border-top-right-radius:' . $border_radius . 'px;';
		$_style_block .= 'border-top-left-radius:' . $border_radius . 'px;';
		$_style_block .= '}';
		$_style_block .= '#' . $wrapper_id . ' .blog-item.-layout1.-contained .card-details{';
		$_style_block .= 'border-bottom-right-radius:' . $border_radius . 'px;';
		$_style_block .= 'border-bottom-left-radius:' . $border_radius . 'px;';
		$_style_block .= '}';

		$_style_block .= '#' . $wrapper_id . ' .blog-item.-layout3.-contained .image-holder,';
		$_style_block .= '#' . $wrapper_id . ' .blog-item.-layout5.-contained .image-holder{';
		$_style_block .= 'border-bottom-left-radius:' . $border_radius . 'px;';
		$_style_block .= 'border-top-left-radius:' . $border_radius . 'px;';
		$_style_block .= '}';
		$_style_block .= '#' . $wrapper_id . ' .blog-item.-layout3.-contained .card-details,';
		$_style_block .= '#' . $wrapper_id . ' .blog-item.-layout5.-contained .card-details{';
		$_style_block .= 'border-bottom-right-radius:' . $border_radius . 'px;';
		$_style_block .= 'border-top-right-radius:' . $border_radius . 'px;';
		$_style_block .= '}';

		$_style_block .= '#' . $wrapper_id . ' .blog-item:not(.-contained) .image-holder,';
		$_style_block .= '#' . $wrapper_id . ' .blog-item.-layout6.-contained .image-holder,';
		$_style_block .= '#' . $wrapper_id . ' .blog-item.-layout6.-contained .card-details{';
