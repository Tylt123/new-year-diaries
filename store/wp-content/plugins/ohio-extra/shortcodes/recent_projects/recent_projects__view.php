...
<div class="ohio-widget portfolio-projects<?php echo esc_attr( $wrapper_classes ); ?> <?php if ( $is_slider ) echo 'vc_row'; ?>" id="<?php echo esc_attr( $wrapper_id ); ?>" <?php echo esc_attr( $animation_attrs); ?> data-ohio-portfolio-grid="true">
	...
	<?php if ( $show_projects_filter && !$is_slider ) : ?>
		...
		<div class="portfolio-filter<?php echo esc_attr( $filter_classes ); ?>" data-filter="portfolio" <?php if ( $filter_is_paged) { echo 'data-filter-paged="true"'; } ?>>
			<ul class="-unlist">
	...
	<?php if ( !$is_slider ) : ?>
		...
		<div class="vc_row portfolio-grid" data-isotope-grid="true" data-lazy-container="projects" data-projects-per-page="<?php echo esc_attr( $projects_in_block); ?>" <?php if ( $card_layout == 'grid_8' ) echo 'data-interactive-links-grid="true"'; ?>>
