...
<div class="ohio-gallery-opened-sc clb-popup clb-gallery-lightbox<?php echo esc_attr( $wrapper_classes . $grid_classes ); ?>" id="<?php echo esc_attr( $wrapper_gallery_id ); ?>" data-options='<?php echo $gallery_json; ?>'>
	<div class="close-bar">
