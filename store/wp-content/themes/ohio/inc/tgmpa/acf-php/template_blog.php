	...
	acf_add_local_field_group([
		...
		"fields" => [
			...
			[
				...
				"label" => __('Blog grid tilt effect', 'ohio'),
				"name" => "grid_items_image_tilt_effect",
				"type" => "inherited_checkbox",
				"instructions" => __('Add tilt effect to item image', 'ohio'),
				"required" => 0,
				"conditional_logic" => 0,
				"custom_labels" => [
					"inherit" => __('Use from Theme Settings', 'ohio'),
			...
			[
				...
				"type" => "inherited_checkbox",
				"instructions" => __('Placing elements in optimal position based on available vertical space', 'ohio'),
				"required" => 0,
				"conditional_logic" => 0,
				"custom_labels" => [
					"inherit" => __('Use from Theme Settings', 'ohio'),
